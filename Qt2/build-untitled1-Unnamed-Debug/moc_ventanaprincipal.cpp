...
static const char qt_meta_stringdata_ventanaPrincipal[] = {
    "ventanaPrincipal\0\0int\0SaludarUsuario()\0"
    "DespedirUsuario()\0AgregarCombo()\0"
    "MoverTextoB2A()\0cargarImagen()\0"
};
...
void ventanaPrincipal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->SaludarUsuario();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: { int _r = _t->DespedirUsuario();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 2: { int _r = _t->AgregarCombo();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 3: { int _r = _t->MoverTextoB2A();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 4: { int _r = _t->cargarImagen();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
